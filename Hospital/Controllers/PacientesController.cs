...
namespace Hospital.Controllers
{
    public class PacientesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Paciente.Include(p => p.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("ID_Paciente,ID_Usuario")] Paciente paciente)
        {
            ...
            ViewData["ID_Usuario"] = new SelectList(_context.Usuario, "Id", "Id", paciente.ID_Usuario);
            return View(paciente);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_Paciente,ID_Usuario")] Paciente paciente)
        {
        ...
        {
          return (_context.Paciente?.Any(e => e.ID_Paciente == id)).GetValueOrDefault();
        }
    }
}
